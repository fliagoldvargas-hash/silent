...
await applyEnvToIndex(`${outDir}/index.html`, env);
...
async function applyEnvToIndex(path, env) {
  let html = await readFile(path, "utf8");
  const pumpfunUrl = env.PUMPFUN_URL || "#pumpfun-soon";
  const caText = env.CA_TEXT || "CA: SOON";
